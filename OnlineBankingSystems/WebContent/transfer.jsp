...
<tr >
	<td width="300" valign="top" style="border-right:#666666 1px dotted;">
    	<div id="services"><h1>Services</h1><br>
		    <ul>
        	<li><a href="#">Online Account Creation</a></li>
            <li><a href="#">Online access of account </a></li>
...
<table><%
		...
		if(status==true){
			...
			PreparedStatement ps=con.prepareStatement("Select * from ACCOUNT where accountno='"+taccountno+"'");
			...
			PreparedStatement ps1=con1.prepareStatement("update ACCOUNT set amount=? where accountno='"+taccountno+"'");
			...
			PreparedStatement ps2=con2.prepareStatement("Select * from ACCOUNT where accountno=?");
			...
			PreparedStatement ps3=con3.prepareStatement("update ACCOUNT set amount=? where accountno='"+accountno+"'");
