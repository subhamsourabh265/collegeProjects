...
<h1><u>User Registered!!!</u></h1>

<% 
String u_id1=request.getParameter("name");
...
pst.setString(1,u_id1);
pst.setString(2,pass1);
pst.setString(3,email1);
pst.setString(4,ans1);
pst.executeUpdate();
pst.close(); 
...
<p><a href="user_login.html">Click here to Login Again</a><br></p>
</div>
