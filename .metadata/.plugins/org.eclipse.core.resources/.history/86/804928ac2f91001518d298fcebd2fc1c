...
<% 
 ...
 %>
    ...
    <div id="tab_content">
       ...
       <table>
       <tr><td bgcolor="#FF9900">Product ID</td><td> <input type="text" name="IPID"></td></tr>
       <tr><td bgcolor="#FF9900">Product Name </td><td> <input type="text" name="IPname"></td></tr>
       <tr><td bgcolor="#FF9900">Product Quantity </td><td> <input type="text" name="IPQuant"></td></tr>
       <tr><td bgcolor="#FF9900">Product Category</td><td>  <input type="text" name="IPcat"></td></tr>
       <tr><td bgcolor="#FF9900">Product Price</td><td>  <input type="text" name="IPprice"></td></tr>
       </table>
