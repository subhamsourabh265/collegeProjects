	...
	public void contextInitialized(ServletContextEvent arg0) {
      ...
      try{
       ...
       if(status==0)
		...
		PreparedStatement ps=con.prepareStatement("CREATE TABLE ACCOUNT(ACCOUNTNO NUMBER,USERNAME VARCHAR2(40),PASSWORD VARCHAR2(40),REPASSWORD VARCHAR2(40),AMOUNT NUMBER,ADDRESS VARCHAR2(40),PHONE NUMBER,PRIMARY KEY (ACCOUNTNO))");
		ps.executeUpdate();
